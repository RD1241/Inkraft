...
<img src="assets/sample_outputs/Banner.png" alt="Inkraft Banner" width="100%"/>
...
**Inkraft** is a fully local AI storytelling engine that converts novel scenes and narrative text into dynamic comic panels, manga pages, cinematic illustrations, and visual story sequences.
...
Inkraft was initially built as a local-first AI storytelling system focused on experimentation, flexibility, and full creative control.
...
```bash
git clone https://github.com/RD1241/Inkraft.git
...
```bash
docker pull ramanduggal/inkraft
```
...
---
# DockerHuB Link-:
https://hub.docker.com/r/ramanduggal/inkraft
...
Inkraft was built as an experimental AI storytelling system focused on transforming narrative text into cinematic comic-style visual experiences using LLMs and diffusion models.
